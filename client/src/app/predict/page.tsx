          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center h-[42px]  transition-all">
                  <input
                    type="range"
                    name="stress_score"
                    min="0"
              ...
              {/* Sleep Duration */}
              <div className="space-y-2">
                <label className="ml-1 text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center">Sleep (hrs)</label>
                <input
              ...
              {/* Caffeine */}
              <div className="space-y-2">
                <label className="ml-1 text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center">Caffeine (mg)</label>
                <input
              ...
              {/* Screen Time */}
              <div className="space-y-2">
                <label className="ml-1 text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center">Screen (min)</label>
                <input
              ...
              {/* Wakes */}
              <div className="space-y-2">
                <label className="ml-1 text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center">Wakes</label>
                <input
